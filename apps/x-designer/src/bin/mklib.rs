fn main() {
    ...
    lib.styles.insert(
        ...
        x_native::Style::Paint {
            fill: x_native::Paint::Solid(x_native::Color::from_rgb8(0x33, 0x66, 0xff)),
        },
    );
    lib.styles.insert(
        "Brand/Warn".into(),
        x_native::Style::Paint {
            fill: x_native::Paint::Solid(x_native::Color::from_rgb8(0xff, 0x5a, 0x00)),
        },
    );
    let mut btn = x_native::Node::rect(
        "lib-btn",
        0.0,
        0.0,
        120.0,
    ...
    btn.kind = x_native::NodeKind::Component {
        name: "LibButton".into(),
    };
