...
mod tests {
    ...
    fn facade_api_is_backend_agnostic() {
        ...
        let circle = node_to_path(&crate::Node::ellipse("c", 0.0, 0.0, 100.0, 100.0, Color::BLACK)).unwrap();
        let rectp = node_to_path(&crate::Node::rect("r", 0.0, 0.0, 100.0, 100.0, Color::BLACK)).unwrap();
