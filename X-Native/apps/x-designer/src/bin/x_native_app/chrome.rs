...
impl XNativeApp {
    ...
    fn right_panel(&mut self, p: Palette) {
        ...
        self.draw_text("Design", x + 16.0, top + 13.0, 11.5, p.text);
        self.draw_text("Prototype", x + 76.0, top + 13.0, 11.5, p.faint);
        self.draw_text("Code", x + 148.0, top + 13.0, 11.5, p.faint);
        self.line(x + 14.0, top + 33.0, x + 57.0, top + 33.0, p.accent, 2.0);
        if self.selected {
